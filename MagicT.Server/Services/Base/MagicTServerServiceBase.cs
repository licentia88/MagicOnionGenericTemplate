...
public class MagicTServerServiceBase<TService, TModel> : MagicTServerServiceBase<TService, TModel, MagicTContext>
...
public class MagicTServerServiceBase<TService, TModel, TContext> : ServiceBase<TService>, IMagicTService<TService, TModel>
    where TService : IMagicTService<TService, TModel>, IService<TService>
    where TModel : class
