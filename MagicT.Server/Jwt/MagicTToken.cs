...
public sealed class MagicTToken
{
    ...
    /// <summary>
    /// Gets or sets the identifier associated with the token.
    /// </summary>
    ...
    /// </summary>
    /// <param name="id">The contact identifier associated with the token, which can be an email or phone number.</param>
    ...
    /// </summary>
    /// <param name="id">The contact identifier associated with the token, which can be an email or phone number.</param>
    /// <param name="identifier">The identifier associated with the token.</param>
    /// <param name="roles">An array of role IDs associated with the token.</param>
