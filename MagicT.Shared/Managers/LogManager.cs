...
public partial class LogManager<TService>: IDisposable
{
    ...
    public void LogMessage(string userId, string message, string callerFilePath = default, string callerMemberName = default)
    {
    ...
    public void LogError(string userId, string message, string callerFilePath, string callerMemberName, int callerLineNumber, string service)
    {
    ...
    /// <param name="callerMemberName">The member name of the caller.</param>
    /// <param name="callerLineNumber">The line number in the source file where the error occurred.</param>
    public void LogCritical(string userId, string message, string callerFilePath, string callerMemberName, int callerLineNumber)
    {
